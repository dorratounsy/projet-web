<?php
        ...
        $produits=$panier_ligneC->get_produit(1);
  
        $panierC=new panierC();

        $panierresult=$panierC->afficherPanieridc(1);
                ...
                <div class="col-lg-3">
                    <div class="top-option">
                        ...
                        <div class="to-social">
                            ...
                            <a href="cart.php" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-shopping-cart"> <span style="color: orange;"><?php echo $nbroduitp; ?></span></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    ?>
      ...
      <form method="POST">
    <img src="img/team/team-2.jpg" height="50px" width="50px">   
      <?php echo $row2[0]; ?>
      <?php echo $row["quantite"]; ?>
      <?php echo $row["prixunitaire"];?>
      <input  name="idlp"  value="<?php echo $row['idlp']; ?>" hidden>
      <button name="dell">delete</button>
        </form>
      </div>
...
<?php
    if(isset($_POST['add'])){
        ...
        $panier_ligne=new panier_ligne(1,$_POST["pid"],1,$_POST["pprice"]);
        
        $panier_ligneC->ajouterpanier_ligne($panier_ligne);

      $produits2=$panier_ligneC->get_produit(1);
        $totale=0;
        $nbroduit=0;
        ...
        $panierC->modifierPanier(1,$nbroduit,$totale);
